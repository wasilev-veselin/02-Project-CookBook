    ...
    <header className="sticky top-0 z-10 border-b border-stone-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <div className="flex items-center justify-between gap-4">
          ...
          <NavLink
            to="/login"
            className="rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-800 lg:hidden"
          >
            Login
          </NavLink>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <NavLink
            to="/login"
            className="hidden rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-800 lg:inline-flex"
          >
            Login
          </NavLink>
        </div>
